...
class _SignUpState extends State<SignUp> {
  ...
  handleEmailIdSubmit() async {
    ...
    final error = await authService.signUpUser(email, password);
  ...
  void updateSignupButtonState() {
    setState(() {
      isSignupActive =
          isEmailValid && passwordTextFieldController.text.isNotEmpty;
    });
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          "Sign up to Manage, Sync, Achieve your Tasks!",
